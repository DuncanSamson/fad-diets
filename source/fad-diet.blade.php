...
@section('content')
    <article class="max-w-3xl mx-auto px-4 py-10">
        ...
        <section class="text-lg mb-6 flex gap-4 pb-10 border-b border-emerald-200">
            ...
            <div>
                <h3 class="font-bold text-xl pb-8">ANIMAL BASED DIET – THE PAUL SALADINO PLAN </h3>
                <p class="text-lg mb-6">
                    This diet focuses on eating primarily animal products such as meat, eggs, and dairy, while also including fruit and honey, with extra focus on avoiding seed oils and vegetables particularly those high in Oxalates (A vegetable’s defence chemical)
                </p>
        ...
        <section class="text-lg mb-6 flex gap-4 pb-10 border-b border-emerald-200">
            <div>
                <h3 class="font-bold text-xl pb-8">CARNIVORE DIET – ALL ANIMAL, NO PLANTS </h3>
                <p class="text-lg mb-6">
        ...
        <section class="text-lg mb-6 flex gap-4">
            ...
            <div>
                <h3 class="font-bold text-xl pb-8">THE LION DIET </h3>
                <p class="text-lg mb-6">
